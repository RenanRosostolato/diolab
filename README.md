...
> [!NOTE]   
> Por exemplo, a URL https://github.com/RenanRosostolato/diolab é o "**fork**" feito pelo usuário do GitHub "`Renan Rosostolato`" para a contribuição no repositório `diolab`.
